...
**D9 Toast** is a lightweight, fully typed, customizable toast notification
library for React and Next.js applications.

## Why D9 Toast?

- ⚡ Minimal bundle size, no external dependencies
- 🔒 100% TypeScript-first API
- 🔔 Built-in audio support with cooldown control
- 🎨 Themes, positions, and action buttons
...
🪙 DONATE :  [https://rzp.io/rzp/eVnJ0oP](https://rzp.io/rzp/eVnJ0oP)
